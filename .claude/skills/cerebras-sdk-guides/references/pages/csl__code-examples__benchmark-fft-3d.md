...
- Source: https://sdk.cerebras.net/csl/code-examples/benchmark-fft-3d
...
N
: Size of 3D FFT along one dimension. The full problem size is
...
NUM_PENCILS_PER_DIM
: Number of pencils along a given dimension on each PE.
For instance,
NUM_PENCILS_PER_DIM
...
FP
: Floating point precision. Valid values are
1
 or
2
, specifying
...
--inverse
: With this flag set, perform an inverse Fourier transform.

--real
: With this flag set, compute Fourier transform with real input
data. Without this flag, complex Fourier transform is computed.

--norm
: Normalization strategy. Valid values are
0
,
1
, or
...
help
=
"Do not validate outcome against numpy implementation"
,
...
help
=
"Normalization (0=backward, 1=ortho, 2=forward."
,
...
help
=
"Save result of FFT to .npy file."
,
...
(
f
"Time to compute FFT and transfer result back:
{
tstop
...
--params
=
N:16,NUM_PENCILS_PER_DIM:4,FP:1 --memcpy --channels
=
1
 -o out
cs_python run.py --name out --real --norm
1

cs_python run.py --inverse --name out --norm
1
...
--params
=
N:16,NUM_PENCILS_PER_DIM:4,FP:0 --memcpy --channels
=
1
 -o out
